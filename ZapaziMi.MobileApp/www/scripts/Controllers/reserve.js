app.controller('ReserveCtrl', function ($scope, $state, $stateParams, $ionicTabsDelegate,
    ...
    var imagePath = "http://diplomna.somee.com/Images/SalonImages/";

    $scope.getFullURL = function (name) {
        return imagePath + name;
    };

    var imagePathEmpl = "http://diplomna.somee.com/Images/EmplImages/";

    $scope.getFullURLEmpl = function (name) {
        return imagePathEmpl + name;
    };

    var imagePathServ = "http://diplomna.somee.com/Images/ServiceImages/";
